...
<!-- Form start here -->
	<div class="container">
	<br>
		<h2><mark><a><b>Medicine Details</b></a></mark></h2><br><br>
		<label for="medicineid"><b>ID</b></label>: <c:out value="${medicine.medicineid}"/><br><br>
		<label for="medicinename"><b>Name</b></label>: <c:out value="${medicine.medicinename}"/><br><br>
		<label for="medicineusage"><b>Usage</b></label>: <c:out value="${medicine.medicineusage}"/><br><br>
		<label for="dosses"><b>Dosses</b></label>: <c:out value="${medicine.dosses}"/><br><br>
		<label for="frequency"><b>Frequency</b></label>: <c:out value="${medicine.frequency}"/><br><br>
		<label for="sideeffect"><b>Side Effect(s)</b></label>: <c:out value="${medicine.sideeffect}"/><br><br>     
        <a href="MedicineController?action=listMedicine&role=<%=role%>"><button>Back</button></a>
	</div>
