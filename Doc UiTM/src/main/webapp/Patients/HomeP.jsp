...
<!-- For header and sticky header -->
	<header>
		...
		<ul >
			<li class="selectMed"><a href="HomeController?action=homeP">HOME</a></li>
...
<form>
	<ul>
			...
			<li class="selHoM"><a href="BookingController?action=listBookings&role=<%=role%>&patientid=<%=id%>">BOOKING</a></li>
