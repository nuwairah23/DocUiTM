...
<title>Add Booking | Doc UiTM</title>
...
<header>
		...
		<ul><li class="selHo"><a href="HomeController?action=homeP">HOME</a></li>
			<li class="selHo"><a href="#e-que">E-QUE</a></li>
			<li class="selectMed"><a href="BookingController?action=listBookings&role=<%=role%>&patientid=<%=id%>">BOOKING</a></li>
		...
		<div class="title-highlight"> <br><br><br><br><br><br><br><br><br><br><br><br><br>
			...
			<h1><mark><a> Booking Form </a></mark><br></h1>
	...
	UiTM ID <br>
	<input  class="in" type="text" name="patientid" value="<%=id %>" required><br>
	Phone Number<br>
	<input  class="in" type="text" name="phonenumber" placeholder="Enter Phone Number" required><br>
	Purpose<br>
    <input  class="in" type="text" name="purpose" placeholder="State Purpose" required><br>
	Date<br>
	<input  class="in" type="date" name="bookingdate" required><br>
	Time<br>
	<input  class="in" type="time" name="bookingtime" required><br>
	<br><input class="sub" type="submit" value="Submit" onclick="alert('Booking Added')">
