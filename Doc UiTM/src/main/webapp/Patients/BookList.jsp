...
<body background="image/medBG-green.png">
	...
	<div class="row">
		...
		<div class="col-md-4 text-right" style="padding-right:150px; padding-bottom:30px">
			<a href="BookingController?action=addBookings" class="btn btn-primary">Add Booking</a>
			<a href="BookingController?action=listBookings&role=<%=role%>&patientid=<%=id%>" class="btn btn-primary">Show All</a><br><br>
		</div>
	</div>
	<div class="table-pad">
	<table class="table table-bordered table-stripped table-hover">
		...
		<tr>
			...
			<td><a href="BookingController?action=viewBookings&bookingid=<c:out value="${book.bookingid}"/>&role=<%=role%>"class="lol">View</a>
		</tr>
		</c:forEach>
 		</tbody>
	</table>
