...
<header>
		...
		<h1><mark><a> Update Booking Form </a></mark><br></h1>
	...
	<mark><a>Booking Details</a></mark><br>
	
	Book ID:
	<input class="in" type="text" name="bookingid" value="<c:out value="${booking.bookingid}"/>"disabled>
	<input class="in" type="hidden" name="bookingid" value="${booking.bookingid}"/>	
	UiTM ID<br>
	<input  class="in" type="text" name="patientid" value="<c:out value="${booking.patientid}"/>"disabled>
	Phone Number<br>
	<input  class="in" type="text" name="phonenumber" value="<c:out value="${booking.phonenumber}"/>"><br>
	Purpose<br>
    <input  class="in" type="text" name="purpose" value="<c:out value="${booking.purpose}"/>"><br>
	Date<br>
	<input  class="in" type="date" name="bookingdate" value="<c:out value="${booking.bookingdate}"/>"><br>
	Time<br>
	<input  class="in" type="time" name="bookingtime" value="<c:out value="${booking.bookingtime}"/>"><br>
	<br><input class="sub" type="submit" value="Submit" onclick="alert('Medicine Added')">
	<a href="BookingController?action=listBookings"><button class="sub">Back</button></a>
	</form>
